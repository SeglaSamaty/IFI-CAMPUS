...
import com.ificampus.mvc.dao.IGenericDao;
...
public class GenericDaoImpl<E> implements IGenericDao<E> {
	...
	public List<E> selectAll(String sortField, String sort) {
		Query query = em.createQuery("select from "+type.getSimpleName()+" t order by " + sortField + sort);
		return query.getResultList();
	}
	...
	public E findOneBy(String paramName, Object paramValue) {
		Query query = em.createQuery("select t from " + type.getSimpleName()+ " t where t." +paramName+ "= :x");
